...
session_start();
  ...
  $query_pesanan = mysqli_query($connection,"SELECT * FROM tb_order WHERE id_pemesan = $id;");
        ...
        <div class="row g-0 align-items-center justify-content-center">
          ...
          <table class="table">
            ...
            <tbody class="table-group">
                <?php while ($query_pesanan1 = mysqli_fetch_assoc($query_pesanan)) :?>
                <tr>
                <th scope="row"><?php echo $query_pesanan1['kode_pemesanan'];?></th>
                <td><?php echo $query_pesanan1['tanggal_pesanan'];?></td>
                <td><?php echo $query_pesanan1['nama_pemesan'];?></td>
                <td><?php echo $query_pesanan1['no_telp'];?></td>
                <td><?php echo $query_pesanan1['barang_pesanan'];?></td>
                <td><?php echo $query_pesanan1['jumlah_pesanan'];?></td>
                <td>
                <?php echo $query_pesanan1['alamat'] .' , '; echo $query_pesanan1['provinsi'].' , '; echo $query_pesanan1['kabupaten'].' , '; echo $query_pesanan1['kecamatan'].' , '; echo $query_pesanan1['kode_pos'];?>  
                </td>
                <?php if($query_pesanan1['status'] == 'Menunggu Konfirmasi'){
                            echo "<td class='bg-warning'>";
                            echo $query_pesanan1['status'];
                            echo"</td>";
                }
                elseif($query_pesanan1['status'] == 'Sedang Dikirim'){
                    echo "<td class='bg-primary'>";
                    echo $query_pesanan1['status'];
                    echo"</td>";
                }
                elseif($query_pesanan1['status'] == 'Selesai'){
                 ...
                 ?>
                <td><?php echo $query_pesanan1['no_resi'];?></td>
                </tr>
                <?php endwhile; ?>
