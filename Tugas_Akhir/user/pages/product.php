      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
          ...
          <ul class="nav navbar-nav d-flex ms-auto me-5">
            ...
            <li class="nav-item dropdown text-center mx-auto">
              <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <span class="fs-6 mx-auto">Hello, <?=$user['username']?>
              </a>
              <ul class="dropdown-menu pe-6 border-0 text-center" aria-labelledby="navbarDropdown">
