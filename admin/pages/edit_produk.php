...
$produk = mysqli_query($connection,$query_produk);

$getProduk = mysqli_fetch_array($produk);
          ...
          <div class="col-md-9 col-lg-9 bg-light  align-items-center justify-content-center">
            <div class="container p-0">
              ...
              <div class="input-data p-2">
                ...
                <form action="../Commands/update_produk.php?id=<?php echo $getProduk['id']; ?>" method="POST" enctype="multipart/form-data">
                    
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nama Produk</label>
                            <input required type="text" class="form-control" placeholder="Nama Produk" name="nama_produk" value="<?php echo $getProduk['nama_produk']; ?>">
                        </div>  
                        

                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Harga Produk</label>
                            <input required type="text" class="form-control" name="harga_produk" placeholder="Harga Produk" value="<?php echo $getProduk['harga_produk']; ?>">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Deskripsi Produk</label>
                            <textarea id="editor" class="form-control" name="deskripsi_produk" placeholder="Deskripsi Produk"><?php echo $getProduk['deskripsi_produk']; ?>
                            </textarea>
                        </div>

                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Stok Produk</label>
                            <input required type="text" class="form-control" name="stok_produk" placeholder="Stok Produk" value="<?php echo $getProduk['stok_produk']; ?>">
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <button name="update_produk" type="submit" class="btn btn-primary">Submit</button>
